...
const VotingSummary = ({ voteHistory }) => {
  ...
  return (
    <div className="mt-2 p-3 border border-term-500/20 rounded bg-gray-900/20 text-sm">
      <div className="mb-2 text-term-300 font-medium text-xs">
      ...
      {Object.entries(tally).map(([pos, count]) => (
        <div key={pos} className="flex items-center mb-1">
          ...
          <div className="w-3/4 bg-gray-700 rounded h-2 mr-2">
            <div
              className="bg-term-500 h-2 rounded"
      ...
      <div className="mt-2 text-term-400 font-medium">
