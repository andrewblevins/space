...
const MigrationModal = ({ isOpen, onComplete }) => {
  ...
  if (step === 'discover') {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-gray-900 p-8 rounded-lg border border-term-600 max-w-md w-full mx-4">
          <h2 className="text-xl font-bold text-term-400 mb-4">
            Welcome to SPACE Terminal 0.2.4!
          </h2>
          
          <div className="space-y-4 text-gray-300">
            <p>
              We found <span className="text-term-400 font-medium">{sessions.length}</span> conversation{sessions.length !== 1 ? 's' : ''} stored in your browser.
            </p>
          ...
          <div className="flex gap-3 mt-6">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-term-500 text-black rounded font-medium hover:bg-term-500 transition-colors"
            >
              Migrate
            </button>
          </div>
        ...
        <div className="bg-gray-900 p-8 rounded-lg border border-term-600 max-w-md w-full mx-4">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-term-500 text-black rounded font-medium hover:bg-term-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
        ...
        <div className="bg-gray-900 p-8 rounded-lg border border-term-600 max-w-md w-full mx-4">
          ...
          <div className="space-y-4">
            ...
            <div className="w-full bg-gray-700 rounded-full h-2">
              <div 
                className="bg-term-500 h-2 rounded-full transition-all duration-300"
  ...
  if (step === 'complete') {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-gray-900 p-8 rounded-lg border border-term-600 max-w-md w-full mx-4">
          <h2 className="text-xl font-bold text-term-400 mb-4 flex items-center">
          ...
          <div className="space-y-4 text-gray-300">
            {results && (
              <div className="bg-gray-800 p-4 rounded">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <div className="text-term-400 font-medium">{results.successful}</div>
            ...
            <div className="bg-term-950 border border-term-600 text-term-400 p-3 rounded text-sm">
          ...
          <button
            ...
            className="w-full mt-6 px-4 py-2 bg-term-500 text-black rounded font-medium hover:bg-term-500 transition-colors"
          >
            Continue to SPACE
          </button>
        </div>
