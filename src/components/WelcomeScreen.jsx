      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <button
            ...
            disabled={loading}
            className="bg-green-400 text-black px-8 py-3 rounded-lg text-lg font-medium hover:bg-green-300 disabled:opacity-50 transition-all duration-200 shadow-lg hover:shadow-green-400/10 mx-auto"
          >
