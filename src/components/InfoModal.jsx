...
const InfoModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-stone-100/70 dark:bg-black/50 flex items-center justify-center z-50" onClick={onClose}>
      <div
        className="bg-stone-50 border border-orange-700 rounded-lg w-full max-w-4xl mx-4 dark:bg-stone-900 dark:border-orange-500 max-h-[90vh] overflow-y-auto overflow-x-hidden flex flex-col"
  ...
  return (
    <div className="space-y-4">
            <div className="text-center">
              <h3 className="text-orange-400 text-lg font-semibold mb-2">SPACE Terminal v0.2.6</h3>
              <p className="text-gray-600 dark:text-orange-200 text-sm">
            ...
            <div className="border-t border-gray-300 dark:border-stone-600 pt-4">
              <h4 className="text-orange-400 font-medium mb-2">About</h4>
              <p className="text-gray-600 dark:text-orange-200 text-sm mb-3">
              ...
              <h4 className="text-orange-400 font-medium mb-3">Features</h4>
            ...
            <div className="border-t border-gray-300 dark:border-stone-600 pt-4">
              <h4 className="text-orange-400 font-medium mb-2">Creator</h4>
              <p className="text-gray-600 dark:text-orange-200 text-sm">
                Created by{' '}
                <a 
              ...
              <p className="text-gray-600 dark:text-orange-200 text-sm mt-2">
...
const ChangelogContent = () => {
  return (
    <div className="space-y-6 text-gray-800 dark:text-orange-100">
      <div className="text-center border-b border-gray-300 dark:border-stone-600 pb-4">
        ...
        <div className="mt-4 p-3 bg-gray-100 dark:bg-stone-800 rounded border-l-4 border-orange-500">
      ...
      <div className="space-y-6">
        <section>
          <h4 className="text-orange-400 font-medium mb-3 text-lg">✨ Major Features</h4>
          
          <div className="space-y-4 ml-4">
            <div>
              <h5 className="font-medium text-gray-900 dark:text-gray-100 mb-2">📱 Mobile Responsive Design</h5>
              <ul className="space-y-1 text-sm text-gray-700 dark:text-orange-200 list-disc list-inside">
        ...
        <section>
          <h4 className="text-orange-400 font-medium mb-3 text-lg">🔧 Technical Enhancements</h4>
        ...
        <section>
          <h4 className="text-orange-400 font-medium mb-3 text-lg">🐛 Bug Fixes</h4>
        ...
        <section>
          <h4 className="text-orange-400 font-medium mb-3 text-lg">🎨 UI/UX Improvements</h4>
