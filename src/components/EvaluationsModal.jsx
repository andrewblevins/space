...
Format: [{"passed": true/false, "reason": "explanation"}, ...]`;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-stone-900 rounded-lg w-full max-w-6xl max-h-[90vh] overflow-hidden flex">
            ...
            {responses.length === 0 ? (
              ...
              responses.map((response, index) => (
                <div
                  ...
                  className={`p-3 border-b border-gray-200 dark:border-stone-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${
                        ...
                        <div 
                          ...
                          className={`p-3 rounded border ${
                            isFromCurrentResponse 
                              ...
                              : 'bg-gray-50 dark:bg-stone-800 border-gray-200 dark:border-stone-700'
                          }`}
                        >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-3">
                      {selectedResponse.evaluations.map((evaluation, evalIndex) => (
                        <div key={evaluation.id} className="p-3 border border-gray-200 dark:border-stone-700 rounded">
      ...
      {showOptimizationModal && (
        <div className="absolute inset-0 bg-black bg-opacity-75 flex items-center justify-center z-10">
          <div className="bg-white dark:bg-stone-900 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            {isOptimizing ? (
              /* Progress View */
