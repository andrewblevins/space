...
const HighCouncilModal = ({ isOpen, onClose, onStartCouncil }) => {
  ...
  return (
    <div className="fixed inset-0 bg-stone-100/70 dark:bg-black/50 flex items-center justify-center z-50" onClick={onClose}>
      <div
        className="bg-stone-50 border border-term-700 rounded-lg w-full max-w-md mx-4 dark:bg-stone-900 dark:border-term-500"
        ...
        <div className="px-6 pb-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={handleStart}
              disabled={!topic.trim()}
              className="flex-1 px-4 py-2 bg-term-500 text-black rounded hover:bg-term-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Start Debate
            </button>
          </div>
