...
const DossierModal = ({ isOpen, onClose, onJumpToSession }) => {
  ...
  const getTagColor = (count, maxCount) => {
    ...
    if (intensity > 0.7) return 'text-orange-300';
    if (intensity > 0.4) return 'text-orange-400';
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={onClose}>
      <div 
        className="bg-gray-900 border border-orange-500 rounded-lg p-6 w-full max-w-4xl max-h-[80vh] overflow-y-auto overflow-x-hidden flex flex-col"
        onClick={e => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-orange-400 text-xl font-semibold">Knowledge Dossier (Beta)</h2>
        ...
        <div className="flex-1 overflow-hidden">
          ...
          {activeTab === 'browse' && (
            <div className="h-full flex">
              ...
              <div className="w-1/3 pr-4 border-r border-gray-700">
                <h3 className="text-orange-400 mb-2 font-medium">
                              ...
                              return (
                                <span 
                                  ...
                                  className={`text-xs px-2 py-1 rounded ${
                                    tagValue === selectedTag ? 'bg-orange-800 text-white' : 'bg-gray-700 text-gray-300'
                                  }`}
                                >
                                  {tagValue}
                                </span>
              ...
              <div className="mb-4">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-stone-900 border border-orange-700 text-white font-sans px-3 py-2 rounded focus:outline-none focus:border-orange-500 placeholder:text-orange-300"
                  />
                  <button
          ...
          {activeTab === 'recent' && (
            <div className="h-full flex flex-col">
              <h3 className="text-orange-400 mb-3 font-medium">
