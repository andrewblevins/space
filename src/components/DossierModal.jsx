...
const DossierModal = ({ isOpen, onClose, onJumpToSession }) => {
  ...
  const getTagColor = (count, maxCount) => {
    ...
    if (intensity > 0.7) return 'text-term-300';
    if (intensity > 0.4) return 'text-term-400';
    if (intensity > 0.2) return 'text-term-500';
    return 'text-term-600';
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={onClose}>
      <div 
        className="bg-gray-900 border border-term-500 rounded-lg p-6 w-full max-w-4xl max-h-[80vh] overflow-y-auto overflow-x-hidden flex flex-col"
      ...
      >
            ...
            <button
              ...
              className={`px-4 py-2 mr-2 border-b-2 transition-colors ${
                activeTab === tab.id 
                  ...
                  : 'border-transparent text-gray-400 hover:text-term-300'
              }`}
            >
              {tab.icon} {tab.label}
            </button>
        ...
        <div className="flex-1 overflow-hidden">
          ...
          {activeTab === 'browse' && (
            <div className="h-full flex">
              ...
              <div className="w-1/3 pr-4 border-r border-gray-700">
                <h3 className="text-term-400 mb-2 font-medium">
                        ...
                        <div key={`${message.sessionId}-${index}`} className="bg-black border border-gray-700 rounded p-3">
                          <div className="flex justify-between items-start mb-2">
                            <span className={`text-sm font-medium ${
                              message.type === 'user' ? 'text-term-400' : 'text-blue-400'
                            }`}>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                className="text-term-400 hover:text-term-300 text-xs underline"
                              >
                                Jump to session
                              </button>
                            </div>
                              ...
                              return (
                                <span 
                                  ...
                                  className={`text-xs px-2 py-1 rounded ${
                                    tagValue === selectedTag ? 'bg-term-800 text-white' : 'bg-gray-700 text-gray-300'
                                  }`}
                                >
                                  {tagValue}
                                </span>
              ...
              <div className="mb-4">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-term-800 text-white rounded hover:bg-term-700"
                  >
                    Search
                  </button>
                </div>
          ...
          {activeTab === 'recent' && (
            <div className="h-full flex flex-col">
              <h3 className="text-term-400 mb-3 font-medium">
