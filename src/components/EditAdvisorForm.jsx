...
const EditAdvisorForm = ({ advisor, onSubmit, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 bg-white/70 dark:bg-black/70 flex items-center justify-center z-[60]">
      <div className="bg-gray-100 p-6 rounded-lg border border-green-600 w-96 max-h-[80vh] overflow-y-auto overflow-x-hidden dark:bg-gray-900 dark:border-green-400 relative">
